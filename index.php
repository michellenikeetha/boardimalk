...
<body>
    ...
    <header>
        ...
        <nav>
            <a href="#home">Home</a>
            <a href="FRONTEND/pages/about.php">About</a>
            <a href="FRONTEND/pages/services.php">Services</a>
            <a href="FRONTEND/pages/customer_dashboard.php">Listings</a>
        </nav>
        <div class="cta-buttons">
            ...
            <?php else: ?>
                <a href="FRONTEND/pages/register.php"><button class="btn-secondary">Register</button></a>
                <a href="FRONTEND/pages/login.php"><button class="btn-primary">Login</button></a>
            <?php endif; ?>
        </div>
    </header>
    ...
    <section id="home" class="hero-section">
        <div class="text">
            ...
            <div class="cta-buttons">
                ...
                <a href="FRONTEND/pages/customer_dashboard.php"><button class="btn-secondary">Explore Listings</button></a>
            </div>
        </div>
    ...
    <section id="featured" class="featured-rentals">
        ...
        <div class="rental-details">
            ...
            <div class="rental-text">
                ...
                <div class="cta-buttons">
                    <a href="FRONTEND/pages/customer_dashboard.php"><button class="btn-primary">Book Now</button></a>
    ...
    <section id="landlords" class="invite-landlords">
        ...
        <div class="cta-buttons">
            <?php if (isset($_SESSION['loggedin']) && $_SESSION['role'] === 'renter'): ?>
                <a href="FRONTEND/pages/renter_dashboard.php"><button class="btn-primary">Post Your Ad</button></a>
            <?php else: ?>
                <a href="FRONTEND/pages/register.php"><button class="btn-primary">Post Your Ad</button></a>
            <?php endif; ?>
            <a href="FRONTEND/pages/termsofservice.php"><button class="btn-secondary">Learn More</button></a>
        </div>
    </section>
    ...
    <footer>
        <div class="footer-content">
            ...
            <div class="footer-section">
                <h4>Quick Links</h4>
                <a href="FRONTEND/pages/about.php">About Us | </a>
                <a href="FRONTEND/pages/membership-packages.php">Membership | </a>
                <a href="FRONTEND/pages/termsofservice.php">Terms of Service</a>
            </div>
            <div class="footer-section">
                <h4>Follow Us</h4>
